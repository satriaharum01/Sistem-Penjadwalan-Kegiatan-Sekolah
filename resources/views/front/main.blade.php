                            ...
                            <div class="row gy-0 gx-5">
                                ...
                                <div class="col-xl-7 animated fadeInLeft">
                                    <div class="text-sm-center text-md-end">
                                        <h4 class="text-primary text-uppercase fw-bold mb-4"> Selamat datang di portal informasi Penjadwalan</h4>
                                        <h1 class="display-4 text-uppercase text-white mb-4">UPT SMP Negeri 27 Medan</h1>
                                        <p class="mb-5 fs-5"> Dapatkan informasi jadwal pelajaran, kegiatan ekstrakurikuler, dan agenda sekolah secara
                                cepat
                                dan akurat untuk mendukung produktivitas 
                                        </p>
                                        <div class="d-flex align-items-center justify-content-center justify-content-md-end">
                                            <h2 class="text-white me-2">Follow Us:</h2>
                                            <div class="d-flex justify-content-end ms-2">
                                                <a class="btn btn-md-square btn-light rounded-circle me-2" href="https://www.facebook.com/SmpNegeri27Medan/?locale=id_ID"><i class="fab fa-facebook-f"></i></a>
                                                <a class="btn btn-md-square btn-light rounded-circle mx-2" href="https://www.instagram.com/smp.n27medan/"><i class="fab fa-instagram"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row g-5">
                                <div class="col-12 animated fadeInUp">
                                    <div class="text-center">
                                        <h4 class="text-primary text-uppercase fw-bold mb-4">Welcome To SMPN 27 Medan</h4>
                                        <h1 class="display-4 text-uppercase text-white mb-4">Membangun Generasi Cerdas dan Berprestasi</h1>
                                        <p class="mb-5 fs-5"> Menciptakan generasi penerus bangsa yang berdaya saing global, berintegritas, dan memiliki
                        semangat
                        untuk
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-xl-7 wow fadeInLeft" data-wow-delay="0.2s">
                        <div>
                            ...
                            <p class="mb-4"> UPT SMP Negeri 27 Medan adalah sebuah lembaga pendidikan menengah pertama yang berlokasi di
                            Jl.
                            Pancing Pasar IV No.2, Kenangan Baru, Kec. Percut Sei Tuan, Medan, Sumatera Utara . Sekolah
                            ini
                            memiliki fasilitas yang cukup lengkap untuk menunjang kegiatan belajar mengajar. Dengan
                            jumlah
                            rombel yang cukup banyak, SMPN 27 Medan berkomitmen untuk memberikan pendidikan berkualitas
                            bagi
                            para siswanya.
                            </p>
                            <div class="row g-4">
                                <div class="col-md-6 col-lg-6 col-xl-6">
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-4">
                                            ...
                                            <p>Memilik berbakai macam kegiatan ekstrakurikuler yang dapat membina masa depan siswa menjadi lebih baik.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-xl-6">
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-4">
                                            ...
                                            <p>UPT SMP NEGERI 27 Medan telah Terakreditasi A (Unggul) yang merupakan sekolah terbaik.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container-fluid service pb-5" id="eskul">
            <div class="container pb-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    ...
                    <p class="mb-0">Ekstrakurikuler adalah kegiatan yang wajib diselenggarakan oleh satuan pendidikan sebagai wadah kegiatan pengembangan karakter dalam rangka perluasan potensi, bakat, minat, kemampuan, kepribadian, kerja sama, dan kemandirian peserta didik secara optimal. Oleh sebab itu, kegiatan ekstrakurikuler harus dikelola secara sistematis dan terpola agar bermuara pada pencapaian tujuan yang diharapkan.</p>
                </div>
                <div class="row g-4">
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="service-item">
                            ...
                            <div class="rounded-bottom p-4">
                                ...
                                <p class="mb-4">Ekstrakurikuler Paskibra melatih kedisiplinan, kepemimpinan, dan kerja sama melalui kegiatan baris-berbaris dan upacara.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="service-item">
                            ...
                            <div class="rounded-bottom p-4">
                                ...
                                <p class="mb-4">Ekstrakurikuler Pramuka membentuk karakter, kemandirian, dan jiwa kepemimpinan melalui kegiatan alam dan keterampilan hidup. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="service-item">
                            ...
                            <div class="rounded-bottom p-4">
                                ...
                                <p class="mb-4">Ekstrakurikuler Karate mengembangkan kedisiplinan, kepercayaan diri, dan kebugaran fisik melalui seni bela diri tradisional.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="service-item">
                            ...
                            <div class="rounded-bottom p-4">
                                ...
                                <p class="mb-4">Ekstrakurikuler Seni Tari mengasah kreativitas, ekspresi diri, dan kekompakan melalui gerakan tari tradisional dan modern.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="service-item">
                            ...
                            <div class="rounded-bottom p-4">
                                ...
                                <p class="mb-4">Ekstrakurikuler Futsal meningkatkan keterampilan bermain, kerja sama tim, dan kebugaran melalui latihan dan pertandingan rutin.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="service-item">
                            ...
                            <div class="rounded-bottom p-4">
                                ...
                                <p class="mb-4">Ekstrakurikuler Pengajian Tahfiz membina hafalan Al-Qur’an, memperkuat iman, dan membentuk akhlak mulia secara rutin dan terarah.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid feature pb-5" id="visiMisi">
            <div class="container pb-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    ...
                    <p class="mb-0">Dalam struktur sebuah unit UPT (Unit Pelaksana Teknis), visi, misi, dan tujuan termasuk dalam elemen perencanaan strategis dan arah kebijakan organisasi. Secara spesifik, ketiganya berfungsi sebagai landasan atau dasar ideologis dan operasional yang menentukan arah, identitas, serta target kinerja unit tersebut.</p>
                </div>
                <div class="row g-4">
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="feature-item p-4">
                            ...
                            <h4>Visi</h4>
                            <p class="mb-4">UPT berkomitmen menciptakan sekolah religius, bersih, sehat, dan ramah anak, menanamkan pengetahuan serta keterampilan untuk pendidikan, serta mengembangkan peserta didik aktif, kreatif, dan terampil demi "Terwujudnya Peserta didik yang Berkarakter, Berbudaya, dan Berpengetahuan."</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="feature-item p-4">
                            ...
                            <h4>Misi</h4>
                            <p class="mb-4">UPT melaksanakan kegiatan pengembangan peserta didik secara menyeluruh, termasuk keagamaan, penguatan karakter, pengembangan ilmu pengetahuan dan teknologi sesuai minat, pembinaan kemandirian kewirausahaan, serta kerja sama harmonis dengan berbagai pihak terkait.
</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.8s">
                        <div class="feature-item p-4">
                            ...
                            <h4>Tujuan</h4>
                            <p class="mb-4">UPT bertujuan membangun budaya sekolah religius dan kondusif dengan lingkungan bersih, indah, sehat jasmani dan rohani. UPT juga mewujudkan sekolah ramah anak tanpa kekerasan, menanamkan pengetahuan dan keterampilan, serta mengembangkan peserta didik aktif dan kreatif.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid team pb-5">
            <div class="container pb-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    ...
                    <p class="mb-0">Guru Terbaik adalah pendidik yang profesional, berdedikasi, dan inspiratif dalam membimbing peserta didik. Mereka mengembangkan kompetensi, menumbuhkan motivasi belajar, serta membangun karakter positif untuk menciptakan generasi unggul dan berprestasi.</p>
                </div>
                <div class="row g-4">
